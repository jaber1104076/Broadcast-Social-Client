...
const SinglePost = ({ post, refetch }) => {
    ...
    const { image, message, place, _id, postLike } = post
    ...
    const handleLike = (id) => {
        ...
        fetch(`http://localhost:5000/myMedia/${id}`, {
            method: 'PATCH',
            headers: {
    ...
    return (
        <div className='mx-10 mb-10'>
            <div className="rounded-md shadow-md  bg-gray-600 text-gray-100">
                <div className="flex items-center justify-between p-3">
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="-space-y-1">
                            ...
                            <span className="inline-block text-xs leading-none dark:text-gray-400">{place}</span>
                        </div>
                    </div>
                ...
                <img src={image} alt="" className="object-cover object-center w-full h-[500px] dark:bg-gray-500" />
                <div className="p-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            <button onClick={() => handleLike(_id)} type="button" title="Like post" className="flex items-center justify-center">
