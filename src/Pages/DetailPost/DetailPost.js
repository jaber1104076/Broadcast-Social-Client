...
const DetailPost = () => {
    ...
    console.log(data);
    const { image, postLike, message, userName } = data
    return (
        <div>
            <h3 className='text-center text-2xl text-slate-700 font-bold mt-5 mb-3'>The detail Post</h3>
            <div>
                <div className="flex flex-col mx-10 p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-500 text-gray-100">
                    ...
                    <div>
                        ...
                        <h2 className="mb-1 text-xl font-semibold">Nature is the creation Of Allah to Enjoy</h2>
